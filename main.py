...
UPDATE_CHNL = os.environ.get("UPDATE_CHNL","seethistoknow")
OWNER_USERNAME = os.environ.get("OWNER_USERNAME","Mrpasserby_1227")
SUPPORT_GRP = os.environ.get("SUPPORT_GRP","Mrpasserby_1227")
